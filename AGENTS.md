...
<file_size_limits>
Any file exceeding 800 lines MUST be split logically into multiple files unless impossible.
</file_size_limits>

<core_principles>

- Plain English: Explain to the user in plain English; avoid internal jargon, bucket numbers, and dense shorthand.
...
- Docs move with the code: Update `.zen/specs/` after any code or layout changes
